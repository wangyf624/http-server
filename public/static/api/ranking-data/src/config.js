config = {
  ...
  color_range: ['#DF523B', '#13D139' , '#0CCCA9' , '#0C75CC' , '#7D0CCC' , "#C30CCC" , "#CC0C5B" , "#CC800C"],
  ...
  //[数据头像设置]
  use_img_type:'circle', //数据头像形状：circle （圆形）、rect（矩形）
  // 数据头像 - 圆形（circle）半径
  circle_radius:40 / 2, //20
  // 数据头像 - 矩形（rect）宽度
  use_img_rect_width:50,
  // 数据头像 - 矩形（rect）高度
  use_img_rect_height:50,
  // 数据头像 - 矩形（rect）圆角矩形的大小
  use_img_rect_rx_size:0,
  // 数据头像 X 轴位移
  circle_x_offset:-22, //-22
  // 数据头像 Y 轴位移
  circle_y_offset:13,  //13
  // 数据头像边框宽度
  circle_border_width:'4px',
  // 数据头像相对定位位置：left（数据条左侧）、right（数据条右侧）
  use_img_position:'left',
  //[数据头像设置]

  // 显示条右侧滚动数字 Y 轴位移
  play_bar_number_y:22,
  // 显示条右侧滚动数字 X 轴位移
  play_bar_number_x:0,

  // 是否显示数据条的文字信息
  barinfo_text_show:'name',

  // showLabel 文字 X 轴位移
  showLabelText_x_offset:0,
  // showLabel 文字 Y 轴位移
  showLabelText_y_offset:20,

  // 数据条圆角矩形的大小（config.rounded_rectangle = true 有效）
  barinfo_rounded_rectangle_size:13,
  // 数据条上文字 Y 轴位移
  barinfo_text_y_offset:2,
  // 数据条上文字 X 轴位移
  barinfo_text_x_offset:0,

  // 数据条进入需要的时间（毫秒）
  barinfo_enter_time:2490,

  // 是否显示数据条左侧数据排名
  barinfo_ranks:false,
  // 数据排名文字 X 轴位移
  barinfo_ranks_x_offset:-60,
  // 数据排名文字 Y 轴位移
  barinfo_ranks_y_offset:20,

  // 等待（n）秒开始动画
  wait_start_time:0,

  //显示榜首项文字
  showTopLabelText:true
};